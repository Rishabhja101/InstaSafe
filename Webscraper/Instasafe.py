...
class Instasafe:
    ...
    def run(self):
        ...
        #had to make this return array so the website has access to the data
        return_array = []
        return_array.append(image_classifier_output)
        return_array.append(language_processor_output)
